              ...
              <Paper style={styles.cardContainer} sx={{}}>
                <Grid container direction="row" justifyContent="left" alignItems="center" spacing={0} sx={{ position: "static", marginTop: '2%',}}>
                  ...
                  <Grid item xs={4}>
                    ...
                    <Grid container direction="column" justifyContent="flex-start" alignItems="flex-start" spacing={0} sx={{ position: "static", marginLeft: '15%',}}>
                      <Grid item xs={0}>
                  ...
                  <Grid item xs={3}>
                    <Grid container direction="column" justifyContent="right" alignItems="flex-end" spacing={0} sx={{ position: "static", marginLeft: "0%"}}>
                      <Grid item xs={0}>
